...
@Repository("testQueryDao")
public class TestQueryDaoImpl extends AbstractDao<Integer, SearchBean> implements TestQueryDao {
...
/*		        
		        ...
		        //thisSearchBean.setPrice((long)tuple[5]);
