...
public class AccountDaoImpl extends AbstractDao<Integer, Account> implements AccountDao {
	...
	public void save(Account account, String role) {
		persist(account); 
		String hql = "insert into com.mumat.model.core.AccountRole (accountId, roleId)"
		        + " select a.id, r.id from com.mumat.model.Account a, "+
				" com.mumat.model.Role r where r.code = :roleId " +
	...
	public Account getAccount(String login) {
		...
		Query query = getSession().createQuery("from com.mumat.model.Account u where u.my_user_name = :login");
