package com.mumat.controller.footer;
...
@Controller
@RequestMapping("/")
public class FooterNavigationController { 
 
	private static final Logger log = Logger.getLogger(FooterNavigationController.class);
